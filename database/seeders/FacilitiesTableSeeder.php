...
class FacilitiesTableSeeder extends Seeder
{
    public function run()
    {
        $facilities = [
            ...
            [
                'name' => 'Pokhara Futsal',
                'description' => 'Located in Pokhara, this outdoor futsal facility offers a fantastic space for players. With a reasonable price per hour, it is an excellent choice for futsal lovers in the Kathmandu area.',
                'location' => 'Pokhara',
                'map_coordinates' => '28.208629696633533,83.99537086486818',
                'price_per_hour' => '900',
                'facility_type' => 'outdoor',
                'opening_time' => '10:30:00',
                'closing_time' => '06:00:00',
